...
const Banner = ({ projectsdata }: any) => {
  ...
  return (
    <div className="relative w-full h-[50vh] md:h-[50vh] lg:h-[100vh] overflow-hidden ">
      <Slider
          ...
          return (
            <div key={slide?.id} className="relative w-full lg:h-[100vh] z-0">
              <Image
                ...
                width={1920}
                height={1080}
                className="object-bottom h-[50vh] lg:h-full object-cover md:object-center w-full "
                priority={true}
              />
            </div>
          );
