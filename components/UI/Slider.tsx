        ...
        <div
          className={`${
            arrow
              ...
              : "absolute inset-0 z-10 top-[45%] h-fit flex items-center"
          }`}
        >
          <button
            onClick={prevSlide}
            ...
            } flex items-center justify-center left-0 h-10 absolute  ${
              !isHovered && "block"
            }`}
          >
          ...
          <button
            ...
            className={`text-heading  ${
              arrow
                ? " text-white text-4xl "
                : "border bg-white/80 text-primary rounded-full w-10"
            } flex items-center justify-center h-10 right-0 absolute ${
              !isHovered && "block"
            }`}
          >
